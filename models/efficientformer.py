...
from models.vision_transformer import to_2tuple, DropPath
...
class Attention(nn.Layer):
    def __init__(self,
        ...
        self.attention_biases = self.create_parameter([num_heads, len(attention_offsets)],
                                                      default_initializer=Constant(1.0e-6))

        self.register_buffer('attention_bias_idxs', paddle.to_tensor(idxs, dtype=paddle.int64).reshape((N, N)))
